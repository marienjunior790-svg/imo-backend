...
export const AuditAction = {
  ...
  PORTAL_SUSPEND: 'PORTAL_SUSPEND',
  PORTAL_REACTIVATE: 'PORTAL_REACTIVATE',
  PORTAL_ARCHIVE: 'PORTAL_ARCHIVE',
  /** Régénération mdp temporaire portail (spec T4 pré-T5) */
  PORTAL_PASSWORD_REGENERATED: 'PORTAL_PASSWORD_REGENERATED',
  /** @deprecated alias — préférer PORTAL_PASSWORD_REGENERATED */
  PORTAL_REGENERATE: 'PORTAL_PASSWORD_REGENERATED',
  ...
  AI_USE: 'AI_USE',
  AI_CHAT: 'AI_CHAT',
  AI_CONTRACT_PROPOSE: 'AI_CONTRACT_PROPOSE',
  AI_CONTRACT_CONFIRM: 'AI_CONTRACT_CONFIRM',
  AI_ACTION_CANCEL: 'AI_ACTION_CANCEL',
  AI_TTS: 'AI_TTS',
